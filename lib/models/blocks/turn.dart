...
class TurnModel extends StatefulWidget {
  String id;
  int speed = 20;
  String _inital = '20';
  ...
  TurnModel(this.id, {this.onChange}) {
    var split = id.split(',');
    if (split.length > 1) {
  ...
  void function() {
    robot.rightJoystick = speed.toDouble();
  }
  ...
  @override
  State<TurnModel> createState() => _TurnModelState();
}

class _TurnModelState extends State<TurnModel> {
  @override
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            Text('Turn robot at speed', style: kCodeBlockText),
            SizedBox(width: 5),
            Container(
